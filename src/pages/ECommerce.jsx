        ...
        >
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-4">
              <p className="flex items-center gap-2 text-gray-600 hover:drop-show-xl">
                <span>
                  <GoDot />
                </span>
                <span>Expenses</span>
              </p>
              <p className="flex items-center gap-2 text-green-600 hover:drop-show-xl">
                <span>
                  <GoDot />
                </span>
                <span>Budget</span>
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-10 border-color m-4 pr-10 ml-10">
              <div>
                <p>
